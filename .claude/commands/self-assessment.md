---
description: Run the Claude Code Self-Assessment. Scores ~/.claude/* state against Boris Cherny's 87 tips and the two-axis Platform Setup vs Execution rubric, then (if configured) posts the summary to Slack.
