      ...
      <header className="mb-10 pb-6 border-b border-[color:var(--color-line)]">
        ...
        <div className="flex items-baseline gap-4">
          ...
          <span className="text-lg text-[color:var(--color-mute)]">
            / {dim.target} target · {deficit} pts to go
          </span>
        ...
        <section className="mb-10">
          ...
          <div className="bg-[color:var(--color-panel)] border border-[color:var(--color-line)] rounded-xl p-5">
            <div className="text-sm mb-3">
              ...
              <span className="text-[color:var(--color-mute)]">+ contributions below, clamped to 0–100.</span>
            </div>
        ...
        <div>
          ...
          {dim.evidence.length ? (
            ...
            <p className="text-sm text-[color:var(--color-mute)]">
              No positive signals captured for this dimension yet.
            </p>
          )}
        </div>
        <div>
          <h2 className="text-xs uppercase tracking-[0.15em] text-[color:var(--color-mute)] mb-3">
            Gaps holding the score down
          </h2>
          {dim.gaps.length ? (
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-2 text-sm">
          {dim.nextActions.map((a) => (
            <li
              key={a.id}
              className="flex items-baseline gap-3 bg-[color:var(--color-panel)] border border-[color:var(--color-line)] rounded-lg p-3"
            >
