...
// a backlog far larger than one run can drain — the CCE-169 shape
const BIG = Array.from({ length: 20 }, (_, i) => 219 + i);
...
const SCENARIOS = [
  {
    ...
    night: {
      ...BASE,
      windowPrs: [221, 222, 223, 224],
      admittedCount: 4,
      pagesFailed: [221],
      baselineAgeDays: 31.2,
    },
  ...
  // --- CCE-169 window cap: does bounding the window subsume CCE-185? ---
  {
    name: "7. CCE-169 cap=10, big backlog, the capped window DRAINS",
    night: {
      ...BASE,
      windowPrs: BIG,
      windowCap: 10,
    ...
    want: "no truncation -> prs == window_prs -> defect 1 unreachable",
  },
  {
    name: "8. CCE-169 cap=10, but the FIRST PR's page group is undrainable",
    night: {
      ...BASE,
      windowPrs: BIG,
      windowCap: 10,
    ...
    want: "i == 0 INSIDE the cap — does the cap still save us?",
  },
];
